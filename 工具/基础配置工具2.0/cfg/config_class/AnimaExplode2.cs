...
{
    /// <summary>
    /// 自动生成的配置类 AnimaExplode2 用于 爆炸动画,拓展请在expand_class文件下使用partial拓展
    /// </summary>
    public partial class AnimaExplode2
    {
        #region 参数及初始化
        /// <summary>
        /// 爆炸id
        ...
        public AnimaExplode2(int id)
        {
            Dictionary<string, object> dict = ConfigLoadSystem.GetCfgIndex(ConfigConstant.Config_AnimaExplode2, id);//public const string Config_AnimaExplode2 = "cfg_AnimaExplode2"; 
        ...
        public AnimaExplode2(string cfg_id)
        {
            Dictionary<string, object> dict = ConfigLoadSystem.GetCfgIndex(ConfigConstant.Config_AnimaExplode2, cfg_id);//public const string Config_AnimaExplode2 = "cfg_AnimaExplode2"; 
			ExplodeId = (int)dict["ExplodeId"];
			AnimaType = (int)dict["AnimaType"];
			Coords = (Vector2I)dict["Coords"];
			LengWidth = (Vector2I)dict["LengWidth"];
        ...
        public AnimaExplode2(Dictionary<string, object> dict)
        {
			ExplodeId = (int)dict["ExplodeId"];
			AnimaType = (int)dict["AnimaType"];
			Coords = (Vector2I)dict["Coords"];

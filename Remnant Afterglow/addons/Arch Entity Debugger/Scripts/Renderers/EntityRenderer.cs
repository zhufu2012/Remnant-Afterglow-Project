...
public class EntityRenderer : IEntityTreeRenderer
{
    ...
    public void Render(bool isNew, TreeItem rootItem, object component, string fieldName)
    {
        ...
        if (isNew)
        {
            rootItem.AddButton(0, ResourceLoader.Load<Texture2D>("res://addons/Arch UnitEntityData Debugger/Assets/Icons/shortcut.png"));
            rootItem.AddButton(1, ResourceLoader.Load<Texture2D>("res://addons/Arch UnitEntityData Debugger/Assets/Icons/expand.png"));
        }

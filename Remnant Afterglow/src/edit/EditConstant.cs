...
namespace Remnant_Afterglow_EditMap
{
	...
	public static class EditConstant
	{
		...
		/// 作战地图 材料选择器，一排的材料数
		/// </summary>
		public static int MapGridSelectPanel_ItemNum = 20;

		/// <summary>
		/// 地图编辑器 层选择控件  当前层颜色
		/// </summary>
		public static Color MapLayerSelectPanel_NowLayerColor = new Color(1f, 0f, 0f,1f);
		/// <summary>
		/// 地图编辑器 层选择控件  当前层颜色
		/// </summary>
		public static Color MapLayerSelectPanel_DefineLayerColor = new Color(1f, 1f, 1f,1f);
		#endregion

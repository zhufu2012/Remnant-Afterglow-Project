...
{    
    ...
    public partial class ConfigConstant
    {
        ...
        /// 档案库主界面
        /// </summary>
        public const string Config_Archival = "cfg_Archival";

        /// <summary>
        /// 档案库子项
        /// </summary>
        public const string Config_ArchivalItem = "cfg_ArchivalItem";
        #endregion
        #region 科技树解锁界面相关配置
        /// <summary>
        /// 科技范围配置
        ...
        /// 道具配置界面数据
        /// </summary>
        public const string Config_ItemDeployData = "cfg_ItemDeployData";

        /// <summary>
        /// 核心插件配置数据
        /// </summary>
        public const string Config_CorePlugDeployData = "cfg_CorePlugDeployData";

        /// <summary>
        /// 科技配置数据
        /// </summary>
        public const string Config_ScienceDeployData = "cfg_ScienceDeployData";
        #endregion
        #region 配置特殊功能表
        /// <summary>
        /// 配置覆盖关系表
        ...
        /// Png散图
        /// </summary>
        public const string Config_GlobalConfigPng = "cfg_GlobalConfigPng";
        ...
        /// 爆炸动画
        /// </summary>
        public const string Config_AnimaExplode = "cfg_AnimaExplode";
        #endregion
        #region 帧动画2
        /// <summary>
        /// 单位帧动画配置
        /// </summary>
        public const string Config_AnimaUnit2 = "cfg_AnimaUnit2";

        /// <summary>
        /// 建筑动画
        /// </summary>
        public const string Config_AnimaBuild2 = "cfg_AnimaBuild2";

        /// <summary>
        /// 炮塔动画
        /// </summary>
        public const string Config_AnimaTower2 = "cfg_AnimaTower2";

        /// <summary>
        /// 无人机动画
        /// </summary>
        public const string Config_AnimaWorker2 = "cfg_AnimaWorker2";

        /// <summary>
        /// 武器动画
        /// </summary>
        public const string Config_AnimaWeapon2 = "cfg_AnimaWeapon2";

        /// <summary>
        /// 爆炸动画
        /// </summary>
        public const string Config_AnimaExplode2 = "cfg_AnimaExplode2";
        #endregion
        #region 序列图
        /// <summary>
        /// 序列图配置
        /// </summary>
        public const string Config_SequenceMapBase = "cfg_SequenceMapBase";
        #endregion
        #region 特效
        /// <summary>
        /// 特效配置
        ...
        /// 实体效果图片
        /// </summary>
        public const string Config_ObjectEffectImage = "cfg_ObjectEffectImage";
        #endregion
        #region 固定地图配置
        /// <summary>
        /// 固定地图配置
        ...
        /// 地图图像集
        /// </summary>
        public const string Config_MapImageSet = "cfg_MapImageSet";

        /// <summary>
        /// 地图资源图集
        /// </summary>
        public const string Config_MapMassif = "cfg_MapMassif";
        #endregion
        #region 图层相关
        /// <summary>
        /// 图像层配置
        /// </summary>
        public const string Config_MapImageLayer = "cfg_MapImageLayer";
        #endregion
        #region 地图生成
        /// <summary>
        /// 随机生成地图用材料
        ...
        /// 地图装饰物配置
        /// </summary>
        public const string Config_MapDecorate = "cfg_MapDecorate";
        #endregion
        #region 大地图生成
        /// <summary>
        /// 生成大地图
        /// </summary>
        public const string Config_BigMapBase = "cfg_BigMapBase";

        /// <summary>
        /// 大地图节点
        /// </summary>
        public const string Config_BigMapMaterial = "cfg_BigMapMaterial";

        /// <summary>
        /// 大地图大结构
        /// </summary>
        public const string Config_BigMapBigCell = "cfg_BigMapBigCell";

        /// <summary>
        /// 节点绘制逻辑
        /// </summary>
        public const string Config_BigMapCellLogic = "cfg_BigMapCellLogic";
        ...
        /// 战役关卡刷怪数据
        /// </summary>
        public const string Config_CopyBrush = "cfg_CopyBrush";

        /// <summary>
        /// 刷怪点数据
        /// </summary>
        public const string Config_BrushPoint = "cfg_BrushPoint";
        ...
        /// 背景音乐
        /// </summary>
        public const string Config_BackgroundMusic = "cfg_BackgroundMusic";
        #endregion
        #region 音效配置
        /// <summary>
        /// UI音效配置
        /// </summary>
        public const string Config_UISoundSfx = "cfg_UISoundSfx";

        /// <summary>
        /// 音效配置
        /// </summary>
        public const string Config_SoundSfx = "cfg_SoundSfx";
        #endregion
        #region 子弹配置
        /// <summary>
        /// 子弹基础数据表
        /// </summary>
        public const string Config_BulletData = "cfg_BulletData";

        /// <summary>
        /// 实体子弹逻辑表
        /// </summary>
        public const string Config_BulletLogic = "cfg_BulletLogic";

        /// <summary>
        /// 激光子弹逻辑表
        /// </summary>
        public const string Config_LaserBulletLogic = "cfg_LaserBulletLogic";
        #endregion
        #region 爆炸配置
        /// <summary>
        /// 爆炸基础数据
        /// </summary>
        public const string Config_ExplodeData = "cfg_ExplodeData";

        /// <summary>
        /// 爆炸伤害数据
        /// </summary>
        public const string Config_ExplodeHarm = "cfg_ExplodeHarm";
        #endregion
        #region 单位配置
        /// <summary>
        /// 单位基础表
        /// </summary>
        public const string Config_UnitData = "cfg_UnitData";

        /// <summary>
        /// 单位逻辑表
        /// </summary>
        public const string Config_UnitLogic = "cfg_UnitLogic";
        #endregion
        #region 实体显示相关配置
        /// <summary>
        /// 实体显示方式表
        ...
        /// 无人机基础表
        /// </summary>
        public const string Config_WorkerData = "cfg_WorkerData";
        #endregion
        #region 武器配置
        /// <summary>
        /// 武器数据1
        /// </summary>
        public const string Config_WeaponData = "cfg_WeaponData";
        ...
        /// 残骸配置
        /// </summary>
        public const string Config_WreckAge = "cfg_WreckAge";
        #endregion
        #region buff配置
        /// <summary>
        /// buff标签数据
        /// </summary>
        public const string Config_BuffTag = "cfg_BuffTag";

        /// <summary>
        /// buff基础数据
        /// </summary>
        public const string Config_BuffData = "cfg_BuffData";
        #endregion
        #region 事件配置
        /// <summary>
        /// 实体事件
        ...
        /// 全局事件
        /// </summary>
        public const string Config_GlobalAttrEvent = "cfg_GlobalAttrEvent";
        #endregion
        #region 全局属性基础表
        /// <summary>
        /// 全局属性表
        /// </summary>
        public const string Config_GlobalAttributeBase = "cfg_GlobalAttributeBase";
        #endregion
        #region 全局属性配置
        /// <summary>
        /// 属性模板表
        /// </summary>
        public const string Config_GlobalAttrTem = "cfg_GlobalAttrTem";

        /// <summary>
        /// 全局属性表
        /// </summary>
        public const string Config_GlobalAttrData = "cfg_GlobalAttrData";

        /// <summary>
        /// 全局修饰器
        /// </summary>
        public const string Config_GlobalAttrMod = "cfg_GlobalAttrMod";
        #endregion
        #region 实体属性基础表
        /// <summary>
        /// 属性表
        ...
        /// 属性模板表
        /// </summary>
        public const string Config_AttributeTemplate = "cfg_AttributeTemplate";
        ...
        /// 属性修饰器
        /// </summary>
        public const string Config_AttrModifier = "cfg_AttrModifier";
        #endregion
        #region 建造列表相关配置
        /// <summary>
        /// 建造列表标签
        ...
        /// 错误码
        /// </summary>
        public const string Config_ErrorBase = "cfg_ErrorBase";
        #endregion
    }
}
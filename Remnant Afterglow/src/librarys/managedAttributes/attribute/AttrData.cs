...
namespace ManagedAttributes
{
    ...
    /// <summary>
    /// FloatAttrData类，继承自ManagAttr基类，用于管理实体的属性
    /// </summary>
    public class AttrData : ManagAttr<float>
    {
        ...
        public AttrData(int attr_id, float val)
        {
            Id = attr_id;
        ...
        public AttrData(int attr_id, float val, float min, float max, float Regen)
        {
            Id = attr_id;
            CurrentValue = val; // 设置当前值
            MinValue = min; // 设置最小值
        ...
        /// <param name="max">最大值</param>
        /// <param name="Regen">再生值</param>
        public AttrData(int attr_id, float val, float min, float max, float Regen, int Priority)
        {
            Id = attr_id;
            CurrentValue = val; // 设置当前值
            MinValue = min; // 设置最小值
        ...
        {
            AttrData floatManaged = (AttrData)container[Attr.Attr_006];//装甲血量比例 

...
namespace Remnant_Afterglow
{
    ...
    public class ModGroup
    {
        ...
        /// mod数量
        /// </summary>
        public int mod_num => modAllInfoList?.Count ?? 0;
        ...
        //mod所有数据
        private List<ModAllInfo> modAllInfoList;
        ...
        {
            return modAllInfoList.Exists(info =>
                    info.file_name == modAllInfo.file_name &&
                    info.modInfo.Name == modAllInfo.modInfo.Name);
        }
        ...
        /// <summary>
        /// 检测是否大体相同  文件夹同名并且mod名称同名才行 不同版本也可能表示为同一个mod，注意
        /// </summary>
